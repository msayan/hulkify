...
class DashboardViewModel(app: Application) : BaseViewModel(app) {
    ...
    fun getCalendar(): MutableList<CalendarEntity> {
        ...
        list.add(CalendarEntity(time = "11:30", isAm = true, title = "Su Faturasını unutma!", icon = R.drawable.ic_add_alarm_black_24dp, bgColor = ContextCompat.getColor(getApplication(), R.color.blue), iconText = "Stark Hatırlatıcı"))
